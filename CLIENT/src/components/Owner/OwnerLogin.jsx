...
const OwnerLogin = ({logged,User,setLogged, setUser }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Simulate OwnerLogin logic with API call (replace with actual API call)
      const response = await fetch('http://localhost:4000/api/v1/auth/login/owner', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        // Redirect to owner dashboard using navigate function
